...
function DialogContent({
  ...
  const hasCustomWidth = className?.includes('w-[') || className?.includes('!w-[') || className?.includes('max-w-') || className?.includes('!max-w-') || style?.width || style?.maxWidth
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          hasCustomWidth && "[&]:!w-auto [&]:!max-w-none",
          className
        )}
        {...props}
      >
